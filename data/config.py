...
liqpay_public_key = read_config['settings']['liqpay_public_key'].strip().replace(" ", "") # публичный ключ Liqpay
liqpay_private_key = read_config['settings']['liqpay_private_key'].strip().replace(" ", "") # приватный ключ Liqpay
# Каналы

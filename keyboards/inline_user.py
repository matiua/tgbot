...
def refill_inl():
    ...
    try:
        liqpay = get_payments()['pay_liqpay']
    except KeyError:
        liqpay = None
    ...
    if liqpay == "True":
        kb.append(InlineKeyboardButton(liqpay_text, callback_data="refill:liqpay"))
...
def pos_buy_inl(pos_id):
    ...
    keyboard.add(InlineKeyboardButton("🛍️ Придбати", callback_data=f"buy_pos:{pos_id}"))
